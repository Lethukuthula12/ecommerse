    ...
    sliders: [
      {
        ...
        content:
          "Excepteur sint occaecat cupidatat non proident sunt in culpa officia deserunt mollit anim laborum sint occaecat cupidatat non proident.",
      },
      {
        id: "2",
       
        title: "Denwen Righteous",
    ...
    return (
      <>
        <OwlCarousel
          ...
          nav={true}
          navText={[
            this.testimonialState.prevIcon,
            this.testimonialState.nextIcon,
          ]}
          dots={true}
          items={1}
          smartSpeed={1000}
            ...
            return (
              <div className="testimonial-item" key={slider.id}>
                <div className="testi-comment">
                  ...
                  <p className="testi__desc">{slider.content}</p>
                </div>
